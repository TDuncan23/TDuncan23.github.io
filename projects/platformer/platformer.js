$(function () {
  ...
  function setup() {
    ...
    createCannon("left", 580, 2000); // cannon on left wall, 680px down, shooting once per second
    createCannon("top", 570, 2300); // cannon on top wall, 570px down, shooting once per second
